...
import styles from './NavMenuMiniDetailedButton.module.scss';

function NavMenuMiniDetailedButton(props) {
    return (
        <button className={styles.navBarBtn} onClick={props.closeMimiNavMenu}>
...
export default NavMenuMiniDetailedButton;
